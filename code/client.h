...
/* RÈcupËre la liste des fichiers dans le rÈpertoire courrant du serveur */
void listeFichiers();

/* 
Fonction permettant l'envoi ‡ une machine distante du fichier dont le chemin est passÈ en paramËtre.
 */
void EnvoiFichier (char * nomFichier);

/* 
Permet de crÈer un fichier de nom passÈ en paramËtre ‡ partir du contenu passÈ en paramËtre.
*/
